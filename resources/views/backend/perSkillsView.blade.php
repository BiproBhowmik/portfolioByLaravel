						...
						<div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12">
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Personal Skills Name</th>
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Personal Skills Percentege</th>
							...
							<tbody>
								...
								<tr role="row" class="odd" id="commonId{{ $item->perSId }}">
									<td>{{ $loop->index }}</td>
									<td>{{ $item->perSName }}</td>
									<td>{{ $item->perSper }}</td>
									<td class="text-left py-0 align-middle">
										<div class="btn-group btn-group-sm text-left">
											<a onclick="editCommon({{ $item->perSId }})" href="javascript:voud(0)" class="btn btn-warning"><i class="fa fa-pencil"></i></a>

											<meta name="csrf-token" content="{{ csrf_token() }}">  {{-- for Delete Ajax --}}
											<button class="btn btn-danger commonDelete" data-id="{{ $item->perSId }}"><i class="fa fa-trash-o"></i></button>
										</div>
									</td>
								</tr>
								@endforeach
				...
				<form action="" method="POST" id="commonAddForm">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Personal Skills</label>
							<input id="commonName" type="text" class="form-control" placeholder="Enter A Personal Skills Name">
						</div>

						<div class="form-group">

							<label for="langName">Personal Skills Percentege</label>
							<input id="commonSkill" type="text" class="form-control" placeholder="Enter A Personal Skills Percentese">
						</div>
					...
					<div class="card-footer">
						<button type="submit" class="btn btn-primary">Add Personal Skills</button>
					</div>
				...
				<form action="" method="POST" id="updateCommonForm">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Personal Skills Name</label>
						...
						<div class="form-group">
							...
							<label for="langName">Personal Skills Percentage</label>
							<input id="updateCommonSkill" type="text" class="form-control" placeholder="Enter A Personal Skills Percentage">
						</div>
					...
					<div class="card-footer">
						<button type="submit" class="btn btn-primary">Update Personal Skills</button>
					</div>
...
@include('backend.myAjax.ajaxPerSkill')
@endsection